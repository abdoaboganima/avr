...
/**
 * @brief Send character to the NOKIA5110 display
 * @param character
 * @note This function sends a character that's decoded into 8*5 bits 
 */
extern void NOKIA5110_sendChar(const  char character);

 /**
 * @brief Send string to NOKIA5110 display
 * @param string 
 */
extern void NOKIA5110_sendString(const char *string);

 /**
 * @brief Draw a full image (48*84 bits) on the NOKIA5110 display
 * @param ptr A ptr to array that constructs the image
 */
extern void NOKIA5110_drawFullImage(const uint8_t *ptr);
